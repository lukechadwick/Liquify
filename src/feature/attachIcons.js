  ...
  for (let file of fileList) {
    ...
    switch (true) {
      case (fileName.innerText.includes(".json")):
        ...
        break;
      case (fileName.innerText.includes(".js") || fileName.innerText.includes(".js.liquid")):
        fileIcon.parentNode.classList.add("is-js");
        fileIcon.style.display = "none";
        break;
      case (fileName.innerText.includes(".scss") || fileName.innerText.includes(".scss.liquid")):
        fileIcon.parentNode.classList.add("is-scss");
        fileIcon.style.display = "none";
        break;
      case (fileName.innerText.includes(".css") || fileName.innerText.includes(".css.liquid")):
  ...
  for (let tab of tabList) {
    switch (true) {
      case (tab.innerText.includes(".json")):
        ...
        break;
      case (tab.innerText.includes(".js") || tab.innerText.includes(".js.liquid")):
        tab.classList.add("is-js");
        break;
      case (tab.innerText.includes(".scss") || tab.innerText.includes(".scss.liquid")):
        tab.classList.add("is-scss");
        break;
      case (tab.innerText.includes(".css") || tab.innerText.includes(".css.liquid")):
